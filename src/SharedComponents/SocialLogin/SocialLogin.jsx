...
const SocialLogin = () => {
  ...
  return (
    <div className="flex justify-center my-5 w-full gap-x-5 font-andika">
      <div
        className="rounded-full text-4xl  btn w-1/4 bg-gradient-to-r from-brand-color to-green-100 hover:bg-gradient-to-r hover:from-green-100 hover:to-brand-color 
