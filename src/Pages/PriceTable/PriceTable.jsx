   ...
   return (
      <div>
         <div className="container mx-auto">
            <h2 className="text-lg md:text-xl lg:text-3xl font-bold text-center text-green-600 my-5">Pricing Table</h2>
            <div className="flex justify-center">
               <h2 className="text-xl md:text-3xl lg:text-5xl font-extrabold text-center text-black my-5 w-1/2">Not any hidden charge, choose
                  our pricing plan</h2>
            </div>
