          ...
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div className="bg-primary/5 text-[#3A9E1E] mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded sm:h-[70px] sm:max-w-[70px]">
                    <svg
                      width="32"
                      height="32"
                      viewBox="0 0 32 32"
              ...
              <div className="relative p-8 bg-white rounded-lg shadow-lg dark:bg-dark-2 sm:p-12">
                <form ref={form} onSubmit={sendEmail}>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 text-white transition border rounded  bg-[#3A9E1E] hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
