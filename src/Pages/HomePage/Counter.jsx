                ...
                <div className="bg-brand-color p-10 my-10 md:flex md:justify-center">
                    ...
                    <div className="flex gap-7 border-b-2 md:border-b-0 md:border-r-2 lg:py-10 lg:px-16 py-5 px-8">
                        ...
                        <div>
                            ...
                            <p className=" lg:text-xl font-semibold text-white mt-5 md:text-center">Total Workers</p>
                        </div>
                    </div>
                    <div className="flex gap-7 md:border-r-2 border-b-2 md:border-b-0 lg:py-10 lg:px-16 py-5 px-8">
                        ...
                        <div>
                            ...
                            <p className=" lg:text-xl font-semibold text-white mt-5 md:text-center">Total Industries Served</p>
                        </div>
                    </div>
                    <div className="flex gap-7  lg:py-10 lg:px-16 py-5 px-8">
                        ...
                        <div>
                            ...
                            <p className=" lg:text-xl font-semibold text-white mt-5 md:md:text-center">Waste Picked & Dispose</p>
                        </div>
                    </div>
                </div>
            </div>
