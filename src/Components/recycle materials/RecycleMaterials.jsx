        ...
        >
          ...
          <div className="hero-content items-start justify-start  text-center">
            <div className="text-white lg:items-start">
              <h1 className="mb-5 text-4xl md:text-5xl font-bold">Become our customer & get <br />
                  special service</h1>
             <div className="flex gap-5 justify-center">
            <Link to={"/contact"}> <button className="btn btn-primary px-5 text-lg bg-brand-color">Contact Us</button></Link>
              <button className="btn btn-primary px-5 text-lg hover:bg-brand-color">Get a Quote</button>
             </div>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="z-0 lg:w-4/5 flex flex-col md:flex-row lg:gap-60 gap-12 justify-between">
            <div className="lg:w-80 mx-auto px-5 md:px-0 text-center lg:text-start text-white">
              ...
              <h1 className="md:mb-5 text-2xl md:text-3xl lg:text-4xl font-bold">We collect, recycle & disposal all materials</h1>
            </div>
